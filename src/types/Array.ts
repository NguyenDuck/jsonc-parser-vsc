...
export type JsonArrayValue = JsonObject | JsonString | JsonNumber | JsonBoolean | JsonNull
...
export class JsonArray extends WithPosition implements CanHaveParent {
	...
	public static from({start, end}: {start?: Position; end?: Position}): JsonArray {
	...
	*[Symbol.iterator](): IterableIterator<JsonArrayValue> {
